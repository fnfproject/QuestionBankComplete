...
namespace TrainerApi.Services
{
    public class UserService : IUserService
    {
        ...
        private const string HardCodedAdminVerificationCode = "TR123456";
        ...
        bool IUserService.VerifyAdminCode(string code)
        {
            return code == HardCodedAdminVerificationCode;
           // var user = _context.Users.FirstOrDefault(u => u.Username == username);
        }

        public void UpdateAdminVerificationStatus(string username)
        {
            var user = _context.Users.FirstOrDefault(u => u.Username == username);
            if (user == null) throw new ArgumentException("User Not Found");
